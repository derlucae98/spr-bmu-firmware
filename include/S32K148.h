...
**         Modified LPI2C_MTDR, LPI2C_STDR, LPIT_CLRTEN and QuadSPI_SPTRCLR registers to Write-Only
**         Modified SIM_FCFG1 registers to Read-Only
**         Added RCM_PARAM_ECMU_LOC bit field
**         Removed SAI_TCR2_BCS, SAI_RCR2_BCS bit field
**
** ###################################################################
*/
...
#define QuadSPI_FR_IPGEF_MASK                    0x0u
