...
/* Customized by Luca Engelmann
 * Size of logged data is constant.
 * Therefore, dynamic memory allocation is not needed
 * Encoded string is appended with \r\n
 */
...
char* base64_table_encode(const unsigned char *table, const unsigned char *src, size_t len, size_t *out_len)
{
    ...
    static unsigned char out[LOGDATA_RAW_SIZE];
